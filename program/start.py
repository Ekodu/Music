...
● **Mən səsli söhbətlərdə musiqi səsləndirən botam 🥰**

● **Hər hansı bir problemlə qarşılaşsanız @BakuCity_Az qrupumuza gəlib yaza bilərsiniz!**
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    ...
                    InlineKeyboardButton("😍 Sahibim", url=f"https://t.me/Nevrozdu"),
                ],
                [
                    InlineKeyboardButton(
                        "💬 Söhbət Qrupum", url=f"https://t.me/BakuCity_Az"
                    ),
                    InlineKeyboardButton(
                        "🥰 Kanalım", url=f"https://t.me/EkoBlogs"
                    ),
                ],
            ]
        ),
...
async def alive(c: Client, message: Message):
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("📣 Dəstək", url=f"https://t.me/Nevrozdu"),
                InlineKeyboardButton(
                    "🗯️ Məlumat", url=f"https://t.me/EkoBlogs"
                ),
            ]
        ]
    )
        ...
        if member.id == bot_id:
            return await m.reply(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton("📣 Məlumat", url=f"https://t.me/EkoBlogs"),
                            InlineKeyboardButton("🗯️ Dəstək", url=f"https://t.me/Nevrozdu")
                        ],
                        [
